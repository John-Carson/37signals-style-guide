...
> URL path-based multi-tenancy patterns.

---

## Path-Based Tenancy with Middleware (this update)
...
## Current Context Pattern (this update, this update)
...
## ActiveJob Tenant Preservation (this update)
...
## Recurring Jobs: Iterate All Tenants (this update)
...
## Session Cookie Path Scoping (this update)
...
## Test Setup for Path-Based Tenancy (this update)

```ruby
# test_helper.rb
Rails.application.config.active_record_tenanted.default_tenant =
  ActiveRecord::FixtureSet.identify(:'test_account')
...
## Always Scope Controller Lookups (this update)
...
## Default Tenant for Dev Console (this update, this update)
...
## Solid Cache Multi-Tenant Config (this update, this update)
...
the application settled on **path-based tenancy with shared database** (not database-per-tenant):
